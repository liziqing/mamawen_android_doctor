/**  
 * @Title: AsynImageLoader.java 
 * @Package cn.net_show.doctor.utils 
 * @author 王帅
 * @date 2015年3月6日 下午4:04:55  
 */ 
package mark.utils;
...
public class AsynImageLoader {  
    ...
    private Bitmap loadDrawable(final ImageView imageView,  
        ...
        final Handler handler = new Handler() {  
            public void handleMessage(Message message) {  
                ImageView imgview = imageViews.get(imageUrl);
                
                if(imgview.getTag()!=null && imgview.getTag().equals(imageUrl)){
    ...
    public Bitmap loadImageFromLocal(String path) {
    	return BitmapTool.getFastBitmap(path);
