...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private String saveCrashInfoToFile(Throwable ex) {
		...
		/*
		 * try { long timestamp = System.currentTimeMillis(); String fileName =
		 * "crash-" + timestamp + CRASH_REPORTER_EXTENSION; // 保存文件
		 * FileOutputStream trace = mContext.openFileOutput(fileName,
		 * Context.MODE_PRIVATE); mDeviceCrashInfo.store(trace, "");
		 * trace.flush(); trace.close(); return fileName; } catch (Exception e)
